    ...
    return <section className="py-24 overflow-x-clip">
        <div className="container relative">
            <div className="absolute -left-32 top-16 hidden lg:block">
                <Image src={DesignExample1} alt="Design Example 1 Image"/>
            </div>
            <div className="absolute -right-64 -top-16 hidden lg:block">
                <Image src={DesignExample2} alt="Design Example 2 Image"/>
            </div>
            ...
            <div className="flex justify-center">
                <div className="inline-flex py-1 px-3 rounded-full bg-gradient-to-r from-purple-400 to-pink-400 text-neutral-950 font-semibold">
                    <span className="rotate-270 mr-2">{' 🚀'}</span> $7.5M seed round raised
                </div>
            </div>
            ...
            <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">
                Design tools shoudn&apos;t slow you down. Layers powerful 
                features with an intuitive interface that in your creative flow.
            </p>
